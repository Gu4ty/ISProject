...
namespace ISProject.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if(!await _roleManager.RoleExistsAsync(Utils.SD.ManagerUser))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(Utils.SD.ManagerUser));
                    }
